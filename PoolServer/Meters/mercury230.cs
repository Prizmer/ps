...
namespace Prizmer.Meters
{
    ...
    /* - перенесена в интерфейс IMeter
    struct RecordPowerSlice
    {
        public float APlus;
        public float AMinus;
        public float RPlus;
    ...
    class m230 : Drivers.LibMeter.CMeter, Drivers.LibMeter.IMeter
    {
        ...
        /// <summary>
        /// Чтение срезов мощности за период времени c начальной даты по текущую, а не по dt_end
        /// </summary>
        ...
        /// <returns></returns>
        public bool ReadPowerSliceOld(DateTime dt_begin, DateTime dt_end, ref List<RecordPowerSlice> listRPS, byte period)
        {
